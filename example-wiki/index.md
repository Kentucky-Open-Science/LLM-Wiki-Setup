...
## Services
- [[service-driftwatch-api]] — FastAPI on [[machine-harbor]]; nightly ingest + /alerts endpoint · 2 sources

## Runbooks
- [[runbook-driftwatch-deploy]] — deploy via git pull + systemd restart on [[machine-harbor]]; verified rollback · 1 source

## Datasets
- [[dataset-buoy-2019-2024]] — NOAA buoy readings 2019–2024, 2.1 GB parquet on [[machine-harbor]] · 2 sources
...
## Machines
- [[machine-harbor]] — Rowan's VPS (2 vCPU/4 GB, Ubuntu 24.04); runs driftwatch; guardrails: live DB not expendable · 4 sources
